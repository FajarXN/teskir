...
const getGlobalSpinner = (disableSpins = false) => {
  if(!globalSpinner) globalSpinner = new spin({ color: 'blue', succeedColor: 'aqua', spinner, disableSpins});
...
CFonts.say(`WELCOME USER KIRBOTZ\nSUBSCRIBE & FOLLOW SOSIAL MEDIA AKU\n--> YOUTUBE : KirBotz×\n--> GITHUB : KirBotz`, {
  font: 'console',
  align: 'center',
